...
export default function EditJournalEntry({ params }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-secondary-800">Edit Entry</h1>
          <p className="text-secondary-500">Update your journal entry</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4">
          <Link href={`/journal/${params.id}`} className="btn-secondary">
            Cancel
          </Link>
          <button
            type="submit"
